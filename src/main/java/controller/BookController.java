        ...
        public void handle(ActionEvent actionEvent) {
            ...
            if (bookDTO != null) {
                ...
                if (deletionSuccessful) {
                    ...
                    bookView.addDisplayAlertMessage("Delete Successful", "Problem at deleting the book", "There was a problem at deleting the book from the database. Please try again !");
                }
            } else {
